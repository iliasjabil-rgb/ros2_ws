...
class SysmapJoystick(Node):
    def __init__(self):
        ...
        self.declare_parameter('axis_stepper_y', 1)
        ...
        self.declare_parameter('button_servo4_cw', 1)
        self.declare_parameter('button_servo4_ccw', 7)
    ...
    def mode_callback(self, msg):
        ...
        if "{" in raw_mode:
            try:
                ...
                self.current_mode = obj.get("data", "IDLE").upper()
            except:
    ...
    def joy_callback(self, msg: Joy):
        ...
        # --- GESTION MOTEURS PAS-A-PAS (MEGA) ---
        AXIS_COLONNE = 1
        AXIS_STOCKAGE = 2
        AXIS_TIGE = 3
        AXIS_RETRACT = 4
